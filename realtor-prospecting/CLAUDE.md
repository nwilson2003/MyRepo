...
- Area: Manchester, New Hampshire and surrounding region (within 100 miles)
- Seed zip code: 03102
...
1. Delegate to **lead-finder**. Pass it the seed zip code and the 100-mile radius above; tell it to search brokerages with offices in or serving that area. It writes `output/agents_raw.csv`.
...
Subagents do not see this conversation. Always pass file paths, the seed zip code and radius, and dates in the delegation prompt.
